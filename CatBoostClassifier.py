...
class CatBoostResNetModel:
    def __init__(self, iterations=100, learning_rate=0.1, depth=6, batch_size=64, random_state=42, use_gpu=False):
    ...
    def train(self, X, y, use_kfold=False, n_splits=5, test_size=0.2):
        ...
        if use_kfold:
            ...
            for fold, (train_idx, test_idx) in enumerate(kf.split(X, y), 1):
                ...
                y_pred = self.classifier.predict(X_test_feat).flatten()
    ...
    def predict(self, X, return_proba=False):
        ...
        if return_proba:
            ...
            predictions = self.classifier.predict(X_feat).flatten()
    ...
    def predict_custom_input(self, input_string):
        ...
        try:
            ...
            prediction_idx = self.classifier.predict(X_feat).flatten()
...
def main():
    try:
        ...
        model = CatBoostResNetModel(iterations=100, learning_rate=0.1, depth=6, use_gpu=use_gpu)
        ...
        while True:
            ...
            if mode == "1":
                ...
                if X is not None and y is not None:
                    ...
                    model_file = f"model/catboost_resnet_model_{dataset_choice}.pkl"
                ...
                model_questions = [
                    inquirer.List('model',
                                  ...
                                  choices=[
                                      ('4 sensor model (catboost_resnet_model_4.pkl)', '4'),
                                      ('6 sensor model (catboost_resnet_model_6.pkl)', '6'),
                                      ('8 sensor model (catboost_resnet_model_8.pkl)', '8')
                                  ],
                                  )
                ]
