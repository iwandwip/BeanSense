...
class MobileNetICCSLightGBMModel:
    ...
    def predict(self, X, return_metrics=False, y_true=None):
        ...
        probabilities = self.classifier.predict_proba(X_feat_selected)
        ...
        while True:
            ...
            if mode == "1":
                ...
                if X is not None and y is not None:
                    ...
                    metrics = model.train(X, y, use_kfold=True, use_cached_features=use_cached, feature_cache_file=feature_cache)
