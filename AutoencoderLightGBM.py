...
class AutoencoderLightGBMModel:
    ...
    def predict_custom_input(self, input_string):
        ...
        try:
            ...
            prediction_idx = self.classifier.predict(X_encoded)
            prediction_label = self.label_encoder.inverse_transform(prediction_idx)

            probabilities = self.classifier.predict_proba(X_encoded)[0]
        ...
        while True:
            ...
            if mode == "1":
                ...
                if X is not None and y is not None:
                    ...
                    model.train(X, y, use_kfold=True, show_plots=show_plots)
