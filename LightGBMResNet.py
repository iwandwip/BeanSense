...
class LightGBMResNetModel:
    def __init__(self, n_estimators=100, learning_rate=0.1, max_depth=6, colsample_bytree=0.8,
                 subsample=0.8, batch_size=64, random_state=42):
...
def main():
    try:
        model = LightGBMResNetModel(n_estimators=100, learning_rate=0.1, max_depth=6)
        ...
        while True:
            ...
            if mode == "1":
                ...
                if X is not None and y is not None:
                    ...
                    model_file = f"model/lightgbm_resnet_model_{dataset_choice}.pkl"
                ...
                model_questions = [
                    inquirer.List('model',
                                  ...
                                  choices=[
                                      ('4 sensor model (lightgbm_resnet_model_4.pkl)', '4'),
                                      ('6 sensor model (lightgbm_resnet_model_6.pkl)', '6'),
                                      ('8 sensor model (lightgbm_resnet_model_8.pkl)', '8')
                                  ],
                                  )
                ]
